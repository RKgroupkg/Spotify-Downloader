...
async def link_handler(Mbot, message):
    ...
    try:
           ...
           try:
              if "MP3" in get_api['links'][0]['t']:
                 try:
                     ...
                     pass 
              dump_file = await message.reply_video(get_api['links'][0]['a'], caption="Thank you for using - @VibeTune_rkbot")
           except KeyError:
        ...
        if 'dump_file' in locals():
            ...
            await m.delete()
        await message.reply("Check out @VibeTune_rkbot  @Rkgroup_bot(Channel) \n Please Support Us By /donate To Maintain This Project")
